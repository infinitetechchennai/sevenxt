        ...
        "items": [
          {
            ...
            "answer":
                "B2B users receive wholesale pricing based on bulk purchasing and business partnerships. B2C users see standard retail pricing. Pricing is automatically adjusted based on your user type."
          },
          {
            "question": "How are prices displayed in my account?",
            "answer":
                "Prices are displayed based on your user type. Log in to view pricing specific to your account category (B2C or B2B)."
          },
        ]
      },
      {
        ...
        "items": [
          {
            ...
            "answer":
                "Yes, we use industry-standard encryption and security protocols to protect your personal and business information."
          },
        ]
      },
    ];
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final isSupportSection = section["category"] == "Support & Contact";
